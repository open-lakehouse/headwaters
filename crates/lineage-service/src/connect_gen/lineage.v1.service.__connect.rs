///Shorthand for `OwnedView<IngestEventRequestView<'static>>`.
...
>;
///Shorthand for `OwnedView<IngestEventResponseView<'static>>`.
...
>;
///Shorthand for `OwnedView<IngestBatchRequestView<'static>>`.
...
>;
///Shorthand for `OwnedView<IngestBatchResponseView<'static>>`.
...
/// Static [`Spec`](::connectrpc::Spec) for the server-side `IngestEvent` RPC.
///
...
/// Static [`Spec`](::connectrpc::Spec) for the server-side `IngestBatch` RPC.
///
/// The dispatcher surfaces this on
/// [`RequestContext::spec`](::connectrpc::RequestContext::spec).
...
///
/// ```rust,ignore
/// let resp = client.ingest_event(request).await?;
...
///
/// ```rust,ignore
/// let owned = client.ingest_event(request).await?.into_owned();
/// ```
///
    ...
    <T::ResponseBody as ::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    /// Call the IngestEvent RPC. Sends a request to /lineage.v1.IngestService/IngestEvent.
    ...
    /// Call the IngestEvent RPC with explicit per-call options. Options override [`ClientConfig`](::connectrpc::client::ClientConfig) defaults.
    ...
    /// Call the IngestBatch RPC. Sends a request to /lineage.v1.IngestService/IngestBatch.
    ...
    /// Call the IngestBatch RPC with explicit per-call options. Options override [`ClientConfig`](::connectrpc::client::ClientConfig) defaults.
